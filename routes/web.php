...
Route::get('/update_status/{id}',[ProductController::class,'update_status'])->name('update_status');
Route::get('/customer_view',[HomeController::class,'customer_view'])->name('customer_view');